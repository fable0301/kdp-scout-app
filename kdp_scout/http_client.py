...
def get_headers():
    ...
    # NOTE: 'br' (brotli) intentionally excluded — requests cannot decompress
    # brotli without the optional 'brotli' package, which causes silent JSON
    # decode failures. Gzip/deflate are always available.
    return {
...
def get_browser_headers():
    ...
    Used for HTML page scraping (product pages) where Amazon requires
    more complete browser-like headers to avoid 404/bot detection.
    """
    return {
        'User-Agent': get_random_user_agent(),
